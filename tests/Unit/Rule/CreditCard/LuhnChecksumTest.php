...
class LuhnChecksumTest extends StringTestCase
{
     ...
     */
    public function testValidateFailsWhenPassingAnInvalidCreditCardNumber(string $creditCardNumber)
    {
        /** @var Result $result */
        $result = yield (new LuhnChecksum())->validate($creditCardNumber);
     ...
     */
    public function testValidateSucceedsWhenPassingAValidCreditCardNumber(string $creditCardNumber)
    {
        /** @var Result $result */
        $result = yield (new LuhnChecksum())->validate($creditCardNumber);
