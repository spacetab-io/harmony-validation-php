...
class Version2Test extends StringTestCase
{
     ...
     */
    public function testValidateFailsWhenPassingAnInvalidV2UuidString(string $uuid): Generator
    {
        /** @var Result $result */
        $result = yield (new Version2())->validate($uuid);
     ...
     */
    public function testValidateReturnsTrueWhenPassingAValidV2UuidString(string $uuid): Generator
    {
        /** @var Result $result */
        $result = yield (new Version2())->validate($uuid);
