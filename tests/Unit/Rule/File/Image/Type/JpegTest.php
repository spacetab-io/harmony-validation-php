...
class JpegTest extends FileTestCase
{
    ...
    {
        /** @var Result $result */
        $result = yield (new Jpeg())->validate(TEST_DATA_DIR . '/image/mspaint.gif');
    ...
    public function testValidateFailsWhenImageIsCorrupted()
    {
        ...
        /** @var Result $result */
        $result = yield (new Jpeg())->validate(TEST_DATA_DIR . '/image/broken-mspaint.jpeg');
    ...
    {
        /** @var Result $result */
        $result = yield (new Jpeg())->validate(TEST_DATA_DIR . '/image/mspaint.jpeg');
